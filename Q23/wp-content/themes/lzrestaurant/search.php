...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="entry-title"><?php printf( esc_html('Results For: %s', 'lzrestaurant' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
	...
	<div class="content-area">
		...
		<?php
	    $layout_option = get_theme_mod( 'lzrestaurant_theme_options','Right Sidebar');
